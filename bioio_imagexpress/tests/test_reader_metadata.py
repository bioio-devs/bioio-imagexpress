...
def test_get_reader_returns_the_reader():
...
def test_bioimage_routes_a_descriptor_on_its_own(acquisition_unit: Path):
    """
...
def test_bioimage_routes_a_descriptor_with_mosaic_off(acquisition_unit: Path):
    """
...
def test_bioimage_reads_a_directory_when_named_explicitly(acquisition_unit: Path):
    """
...
def test_bioimage_cannot_route_a_directory_on_its_own(acquisition_unit: Path):
    """
...
def test_a_bare_tiff_is_left_to_bioio_tifffile(acquisition_unit: Path):
