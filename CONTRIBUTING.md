...
Ready to contribute? Here's how to set up `bioio-imagexpress` for local development.

1. Fork the `bioio-imagexpress` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/bioio-imagexpress.git
    ```

3. Install the project in editable mode. (It is also recommended to work in a virtualenv or anaconda environment):

    ```bash
    cd bioio-imagexpress/
    just install
    ```
